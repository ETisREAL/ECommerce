...
class CategoryFactory(factory.django.DjangoModelFactory):
    ...
    name = factory.Sequence(lambda n: 'test_name_%d' % n)
    slug = fake.lexify(text='test_slug_??????')
...
class ProductFactory(factory.django.DjangoModelFactory):
    ...
    is_active = True
    created_at = '2022-09-11 14:00:15.935571'
    updated_at = '2022-09-11 14:00:15.935571'
...
class ProductAttributeFactory(factory.django.DjangoModelFactory):
    ...
    description = factory.Sequence(lambda n: 'description_name_%d' % n)
...
class ProductAttributeLinkTableFactory(factory.django.DjangoModelFactory):
    class Meta:
        model = models.ProductAttributeLinkTable

    attribute_values = factory.SubFactory(ProductAttributeValueFactory)
    product_inventory = factory.SubFactory(ProductInventoryFactory)


class ProductWithAttributeLinkTableFactory(ProductInventoryFactory):
    attributevalues1 = factory.RelatedFactory(
        ProductAttributeLinkTableFactory,
...
register(ProductAttributeLinkTableFactory)
