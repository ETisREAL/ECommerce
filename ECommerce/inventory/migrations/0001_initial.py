    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='format: required, letters, numbers, underscore or hyphons', max_length=150, verbose_name='category safe URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='format: required, letters, numbers, underscore or hyphons', max_length=255, verbose_name='product safe URL')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='format: Y-m-d H:M:S')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retail_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='maximum price 999.99', max_digits=5)),
                ('store_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='maximum price 999.99', max_digits=5)),
                ('sale_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='maximum price 999.99', max_digits=5)),
                ('weight', models.FloatField(verbose_name='product weight')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('attribute_values', models.ManyToManyField(related_name='product_attribute_link_table', through='inventory.ProductAttributeLinkTable', to='inventory.productattributevalue')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('last_checked', models.DateTimeField(blank=True, help_text='format: Y-m-d H:M:S, null-true, blank-true', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='attributelinktable', to='inventory.productattributevalue'),
        ),
        migrations.AddField(
            model_name='productattributelinktable',
            name='product_inventory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='inventorylinktable', to='inventory.productinventory'),
        ),
        migrations.CreateModel(
            name='Media',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='product visibility')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='date sub-product created')),
