...
def test_inventory_db_product_attrubite_insert_data(
    ...
    assert new_attribute.description == "description_name_0"
...
def test_inventory_db_insert_inventory_product_value_link_table(
    db, product_with_attribute_link_table_factory
):

    new_inv_attribute = product_with_attribute_link_table_factory(sku="123456789")
